...
export function Room(){
  ...
  const { title, questions, roomAuthor } = useRoom(roomId);
  ...
  async function handleSendQuestion(event: FormEvent){
    ...
    if(!user){
      throw new Error('Voce deve estar logado'); //talvez usar react-hot-toast
    }
      ...
      <header>
        <div className="content">
          ...
          <div>
            ...
            { roomAuthor === user?.id && (<Button isOutlined onClick={() => {history.push(`/admin/rooms/${roomId}`)}}>Modo Admin</Button>) }
          </div>
        </div>
      </header>
